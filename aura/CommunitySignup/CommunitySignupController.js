({
    ...
    doSignup : function(component, event, helper){
        ...
        var user ={howToKnowCopado:'', referalCode:'', customerType:'', firstName:'', lastName:'', email:'', jobRole:'', jobRoleOther:'', country:'', state:'', city:'', zipcode:'', companyName:'', corporateEmail:'', title:'', iAmExistingCustomer:false, iAmExistingPartner:false};
        ...
        user.howToKnowCopado = component.find("HowToKnowCopado").get("v.value");

        if(user.howToKnowCopado == 'Event') {
            user.referalCode = component.find("ReferalCode").get("v.value");
        }
