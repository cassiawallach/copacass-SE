...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        <fullName>Academy_Certification_Survey</fullName>
        <description>Academy Certification Survey</description>
        <protected>false</protected>
        <recipients>
            <field>redwing__Contact__c</field>
            <type>contactLookup</type>
        </recipients>
        <senderAddress>academy@copa.do</senderAddress>
        <senderType>OrgWideEmailAddress</senderType>
        <template>Academy/Copado_Certification_Survey</template>
    </alerts>
    <alerts>
        <fullName>Academy_Maintenance_Completed_Email2</fullName>
        <description>Academy Maintenance Completed Email</description>
        <protected>false</protected>
        <recipients>
            <field>redwing__Contact__c</field>
            <type>contactLookup</type>
        </recipients>
        <senderAddress>academy@copado.com</senderAddress>
        <senderType>OrgWideEmailAddress</senderType>
        <template>Academy/Maintenance_Exam_Results_New</template>
    </alerts>
    <alerts>
