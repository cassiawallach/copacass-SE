...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <active>false</active>
        <description>***DEACTIVATED March 2022 per User Story US-0029093 - Scott M***</description>
        <formula>/* ***DEACTIVATED March 2022 per User Story US-0029093 - Scott M*** */  NOT(ISBLANK(kugo2p__Opportunity__c))</formula>
