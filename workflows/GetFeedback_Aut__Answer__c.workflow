...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <recipients>
            <recipient>aarezzi@copado.com</recipient>
            <type>user</type>
        </recipients>
        <recipients>
            <recipient>dprieto@copa.do</recipient>
            <type>user</type>
        </recipients>
        <recipients>
        ...
        <recipients>
            <recipient>nnatha@copado.com</recipient>
            <type>user</type>
        </recipients>
        <recipients>
            <recipient>pmcqueen@copado.com</recipient>
            <type>user</type>
        </recipients>
        <recipients>
            <recipient>rsudhadayana@copado.com</recipient>
            <type>user</type>
        </recipients>
