...
Renewal: Old opportunity name</description>
  ...
  Account.Name  &amp; &apos; - Renewal &apos; &amp;  TEXT(YEAR(TODAY()) + 1)
    ...
    <rules>
        ...
        <description>***DEACTIVATED March 2022 per User Story US-0029359 - Scott M***

Sets name of Renewal Opportunity to &quot;Account Name Renewal - Year&quot;</description>
    ...
    <rules>
        ...
        <description>Sets Opportunity Type for &quot;Renewal&quot;
24/03/2022 : Deactivated this because its logic has been moved into trigger as per the story US-0029567.</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
