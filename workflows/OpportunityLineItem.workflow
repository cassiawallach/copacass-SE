...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
  ...
  IF(
    ...
    <fieldUpdates>
        <fullName>kuga_sub__UpdateOpportunityProductARRForecast</fullName>
        <field>kuga_sub__ARRForecast__c</field>
        <formula>IF(
  ISBLANK(kuga_sub__MRR__c),
  NULL,
  kuga_sub__MRR__c * 12
)</formula>
        <name>Update Opportunity Product ARR Forecast</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
  ...
  OR(
    Product2.kuga_sub__Renewable__c = FALSE,
    ISBLANK(kuga_sub__ServiceTerm__c),
    kuga_sub__ServiceTerm__c = 0
  ),
  0,
  IF(
    AND(
    ...
    <rules>
        ...
        <active>false</active>
        <description>23/03/2022 : Deactivated this because its logic has been moved into trigger as per the story US-0029351.</description>
    ...
    <rules>
        ...
        <active>false</active>
        <description>Populates the Engagement Type field based on the value on the Product field.
23/03/2022 : Deactivated this because its logic has been moved into trigger as per the story US-0029351.</description>
    ...
    <rules>
        ...
        <actions>
            <name>kuga_sub__UpdateOpportunityProductARRForecast</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
