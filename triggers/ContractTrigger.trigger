trigger ContractTrigger on Contract (before update,before insert,after insert, after update) {
   ...
   if(trigger.isBefore && trigger.isInsert){
       ...
       ContractHelper.populateFieldsOnInsert(trigger.new);
   } 
   if(trigger.isBefore && trigger.isUpdate){
       ContractHelper.populateFieldsOnUpdate(trigger.oldMap,trigger.newMap);
   }
   if(trigger.isInsert) {  
